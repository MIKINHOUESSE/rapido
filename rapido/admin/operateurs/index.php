<?php
session_start();
include_once("../../assets/includes/functions&Objet.php");
$url1 = "/chauffeur/";
$url2 = "/operateur/";
$url3 = "/";
...
<body>
    ...
    <!--Classe-->
    <!--Code pour ajouter le opérateur-->
    <div class="ajoutModal p-0 pt-5">
                <div class="ajoutModal-content">
                    <span class="close">&times;</span>
                    <div class="image-formulaire">
                    <div class="images bg2">
                            <img class="pb-6" src="/assets/images/logo.png" width="100%" >
                            <div class="flootage"></div>
                            <div class="text-center pb-5">
                                <h1>Vos informations</h1>
                                <h1>sont sécurisée</h1>
                            </div>
                        </div>
                        <div class="formulaire container" id="premier-index">
                            ...
                            <form method="post" class="formemaj">
                                ...
                                <input type="text" name="nom" id="nom" placeholder="nom du opérateur ...">
                                <label for="prenoms">Prénoms :</label><br>
                                <input type="text" name="prenoms" placeholder="prénoms du opérateur" id="nom">
                                ...
                                <hr>
                                <input type="reset" value="Nettoyer les champs" class="bg-danger text-white  border-0">
                            </form>
                        </div>
                    </div>
                </div>
